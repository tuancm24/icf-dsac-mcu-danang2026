...
/* =========================================================================
 * Button Driver Complete Verification & Hardware Board Test Runner
 * Target MCU: SONiX SN8F5708 EVK (Ultra-Lean Build < 500 Bytes)
 * ========================================================================= */
...
void main(void)
{
    ...
    /* =====================================================================
     * SECTION B: Interactive Live Board Execution Loop
     * ===================================================================== */
    /* Clear all simulation flags so physical hardware pins are read directly */
    GPIO_SimulateButtonPress(BUTTON_ID_SW3, 0);
    GPIO_SimulateButtonPress(BUTTON_ID_SW6, 0);
    GPIO_SimulateButtonPress(BUTTON_ID_SW10, 0);
    GPIO_SimulateButtonPress(BUTTON_ID_SW16, 0);
    ...
    while (1)
    {
        ...
        /* 2. Check for validated Click Events from FIFO queue */
        event = Button_GetEvent();
